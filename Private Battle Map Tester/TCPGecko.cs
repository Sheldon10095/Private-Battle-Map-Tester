...
namespace Private_Battle_Map_Tester
{
    ...
    public class TCPGecko
    {
        ...
        public void Dump(UInt32 startdump, UInt32 enddump, Stream[] saveStream)
        {
            ...
            if (Private_Battle_Map_Tester.ValidMemory.rangeCheckId(startdump) != Private_Battle_Map_Tester.ValidMemory.rangeCheckId(enddump))
            {
                enddump = Private_Battle_Map_Tester.ValidMemory.ValidAreas[Private_Battle_Map_Tester.ValidMemory.rangeCheckId(startdump)].high;
            }

            if (!Private_Battle_Map_Tester.ValidMemory.validAddress(startdump)) return;
        ...
        */
        ...
        {
            if (!Private_Battle_Map_Tester.ValidMemory.validAddress(address))
            {
                return 0;
            }
